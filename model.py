...
class AngularMagnitudeLoss(nn.Module):
    ...
    def forward(self, v_p, v_h, labels):
        ...
        # Smooth L1 provides a constant gradient, forcing vectors to the poles 
        # without causing the gradient explosions of MSE or scaled CE.
        loss_ang = F.smooth_l1_loss(cos_sim, target_cos)
